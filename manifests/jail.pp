...
#
# [*service_autorestart*]
#   cbsd will be restarted on config changes, but this behaviour
#   can be disabled by setting this parameter.
#
# [*template*]
#   Override the default template from cbsd::params use to define
#   jail config.
#
...
$host_hostname         = '',
  ...
  ### integrity check
  $valid_params = cbsd_integrity_check()
  ...
  $manage_file_path = "${cbsd::config_dir}/${name}.conf"
